"""Implements model class for hand with 4 fingers
    ...
    _hand_defaults = SafeFString(
        ...
        <default>
            ...
            <default class="ur5e">
                ...
                <default class="size1">
                    <general gainprm="80" biasprm="0 -75 -15" forcerange="-28 28"/>
                </default>
                        ...
                        <body name="wrist_1_link" pos="0 0 0.392" quat="1 0 1 0">
                            ...
                            <body name="wrist_2_link" pos="0 0.127 0">
                                ...
                                <body name="wrist_3_link" pos="0 0 0.1">
                                    ...
                                    <!-- Hand -->
                                    <geom name="hand_plate" type="cylinder" size="0.14 0.02" euler="1.5707963267948966 0 0" pos="0 0.08 0"></geom>
                                    <body name="hand_plate" euler="-1.5707963267948966 0 0" pos="0 0.04 0">
                                        <!-- Finger 1 -->
                                        <body name="finger1_proximal" childclass="prox_link" pos="-0.110 0.0 0.0" euler="1.5707963267948966 -1.5707963267948966 0">
                                        ...
                                        <!-- Finger 2 -->
                                        <body name="finger2_proximal" childclass="prox_link" pos="0.077 0.077 0.0" euler="1.5707963267948966 2.35 0">
                                            <inertial pos="0 0 0" mass="0.09313" fullinertia="0.00026367817 0.00001529521 0.00026733699 0.00000191262 -0.00000000394 -0.00000000009"></inertial>
                                        ...
                                        <!-- Finger 3 -->
                                        <body name="finger3_proximal" childclass="prox_link" pos="0.110  0.0  0.0" euler="1.5707963267948966 1.57 0">
                                            <inertial pos="0 0 0" mass="0.09313" fullinertia="0.00026367817 0.00001529521 0.00026733699 0.00000191262 -0.00000000394 -0.00000000009"></inertial>
                                        ...
                                        <!-- Finger 4 -->
                                        <body name="finger4_proximal" childclass="prox_link" pos="0.077 -0.077  0.0" euler="1.5707963267948966 0.785 0">
                                            <inertial pos="0 0 0" mass="0.09313" fullinertia="0.00026367817 0.00001529521 0.00026733699 0.00000191262 -0.00000000394 -0.00000000009"></inertial>
